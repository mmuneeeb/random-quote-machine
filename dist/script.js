...
class App extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
  ...
  render() {
    ...
    return /*#__PURE__*/(
      React.createElement("div", { id: "quote-box", className: "wrapper d-flex align-items-center justify-content-center vh-100" }, /*#__PURE__*/
      React.createElement("div", { className: "col-6 box p-3 rounded" },

      quote && /*#__PURE__*/
      React.createElement("div", { className: "mb-4" }, /*#__PURE__*/
      React.createElement("p", { id: "text" }, /*#__PURE__*/React.createElement("i", { className: "fas fa-quote-left" }), quote.quote), /*#__PURE__*/
      ...
      React.createElement("a", { id: "tweet-quote", href: tweetURL, target: "_blank", className: "btn btn-primary" }, /*#__PURE__*/React.createElement("i", { class: "fab fa-twitter" }), "Tweet"), /*#__PURE__*/
      React.createElement("button", { id: "new-quote", className: " btn btn-primary", onClick: this.getRandomIndex }, "Get Quote"))))));
